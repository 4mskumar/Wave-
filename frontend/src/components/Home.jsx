...
const Home = () => {
  ...
  return (
    <>
      ...
      <main className="pt-20 md:pl-72 pb-20 bg-gray-50 min-h-screen transition-all duration-300">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 py-6">
          
          <div className="bg-gray-100 shadow rounded-2xl p-4 sm:p-6 mb-6 border border-gray-200">
