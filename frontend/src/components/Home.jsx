...
const Home = () => {
  const [posts] = useState([
    ...
    },
    {
      ...
      time: "6 Aug at 1:00 PM",
      text: "Enjoying a calm evening 🌅",
      image:
            ...
            {posts.map((post) => (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  ...
                  />
                  <div>
                    <p className="font-semibold text-[15px] sm:text-[17px]">
                      {post.name}
                    </p>
                ...
                {post.image && (
                  <>
                    ...
                    {(post.Likes || post.Comments) && (
                      <div className="flex flex-wrap justify-between sm:justify-normal items-center text-gray-600 text-sm mt-4 gap-4 sm:gap-10 px-2 sm:px-4">
